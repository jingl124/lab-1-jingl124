...
ggplot(midwest, aes(x = popdensity)) + 
  geom_histogram(binwidth = 10000) + labs(x = "Population density", y = "Count", title = "Population density of counties")
...
ggplot(midwest, aes(x = percollege, y = percbelowpoverty, color = state)) + 
  ...
  labs(x="% with college degree", y="% in poverty", title="Percent with college degrees vs. Percent in poverty")
```
